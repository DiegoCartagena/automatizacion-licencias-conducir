...
import {
  ...
  k,
  te
} from "./chunk-5FQIXCWX.js";
import "./chunk-EE2DYTTY.js";
import "./chunk-RU2UXFRB.js";
import {
  __commonJS,
  __toESM
...
function T(e, o) {
  let n = typeof e == "string" ? e : null, p = typeof e == "string" ? o : e, t = n ? Fe.restore(n) : null, a = typeof p == "object" ? (0, import_lodash2.default)(p) : (0, import_lodash2.default)(p()), l = null, f = null, h2 = (r) => r, y = reactive({ ...t ? t.data : (0, import_lodash2.default)(a), isDirty: false, errors: t ? t.errors : {}, hasErrors: false, processing: false, progress: null, wasSuccessful: false, recentlySuccessful: false, data() {
    ...
    let m = h2(this.data()), b = { ...i, onCancelToken: (u) => {
      if (l = u, i.onCancelToken) return i.onCancelToken(u);
    }, onBefore: (u) => {
      if (this.wasSuccessful = false, this.recentlySuccessful = false, clearTimeout(f), i.onBefore) return i.onBefore(u);
    }, onStart: (u) => {
      if (this.processing = true, i.onStart) return i.onStart(u);
    }, onProgress: (u) => {
      if (this.progress = u, i.onProgress) return i.onProgress(u);
    }, onSuccess: async (u) => {
      ...
      let N = i.onSuccess ? await i.onSuccess(u) : null;
      return a = (0, import_lodash2.default)(this.data()), this.isDirty = false, N;
    }, onError: (u) => {
      if (this.processing = false, this.progress = null, this.clearErrors().setError(u), i.onError) return i.onError(u);
    }, onCancel: () => {
      if (this.processing = false, this.progress = null, i.onCancel) return i.onCancel();
    }, onFinish: (u) => {
      if (this.processing = false, this.progress = null, l = null, i.onFinish) return i.onFinish(u);
    } };
    r === "delete" ? Fe.delete(s, { ...b, data: m }) : Fe[r](s, m, b);
  }, get(r, s) {
    this.submit("get", r, s);
  }, post(r, s) {
...
var W = defineComponent({ name: "Inertia", props: { initialPage: { type: Object, required: true }, initialComponent: { type: Object, required: false }, resolveComponent: { type: Function, required: false }, titleCallback: { type: Function, required: false, default: (e) => e }, onHeadUpdate: { type: Function, required: false, default: () => () => {
  ...
  return k2 = Y(a, p, t), a || (Fe.init({ initialPage: e, resolveComponent: n, swapComponent: async (l) => {
    ...
    if (c.value) {
      ...
      return x.value && (c.value.layout = x.value, x.value = null), c.value.layout ? typeof c.value.layout == "function" ? c.value.layout(h, l) : (Array.isArray(c.value.layout) ? c.value.layout : [c.value.layout]).concat(l).reverse().reduce((f, h2) => (h2.inheritAttrs = !!h2.inheritAttrs, h(h2, { ...d.value.props }, () => f))) : l;
    }
  };
} });
var E = W;
...
async function j({ id: e = "app", resolve: o, setup: n, title: p, progress: t = {}, page: a, render: l }) {
  let f = typeof window > "u", h2 = f ? null : document.getElementById(e), y = a || JSON.parse(h2.dataset.page), r = (m) => Promise.resolve(o(m)).then((b) => b.default || b), s = [], i = await r(y.component).then((m) => n({ el: h2, App: E, props: { initialPage: y, initialComponent: m, resolveComponent: r, titleCallback: p, onHeadUpdate: f ? (b) => s = b : null }, plugin: $ }));
  if (!f && t && ee(t), f) {
